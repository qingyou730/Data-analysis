<template>
  <div class="my-form-row">
    ...
    <div style="display: inline-block;">
      ...
      <!-- <el-date-picker class="111111111111111111111111111111111"
      ...
      ></el-date-picker>
      <span style="color:#f56c6c;" v-show="range_time&&self_value.type=='STATIC'">
      ...
      <!-- <el-select v-show="self_value.type=='DYNAMIC'" v-model="self_value.hour">
        <el-option
  ...
  methods: {
    ...
    onTimeChange() {
      ...
      if (day > 60) {
        ...
        this.self_value.range[1] = new Date(rangeTime).Format("yyyy-MM-dd")+' '+resultEnd;
      }
      this.self_value.start = this.self_value.range[0];
