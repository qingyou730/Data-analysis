<template>
  <el-form label-width="150px">
    <el-form-item label="用户名 : ">
      <el-input v-model="user_id" disabled readonly style="width:400px;" @change="setEmail"></el-input>
    </el-form-item>
    <el-form-item label="真实姓名 : ">
      <el-input v-model="user_name" disabled readonly   style="width:400px;"></el-input>
    </el-form-item>
    <el-form-item label="所属部门 : ">
      <el-select filterable v-model="group" style="width:400px;">
    ...
    <el-form-item label="邮箱 : ">
      <el-input v-model="email" type="mail" style="width:400px;"></el-input>
    </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit: function() {
        ...
        var url = this.$store.state.api_url.admin.update;
        this.axios.post(url, param).then((response) => {
          let data = response.data
          if (data.code == 200) {
            this.$success("操作成功");
