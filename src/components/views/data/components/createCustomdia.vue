<template>
  <div class="custom-rewrite-file">
    <el-dialog title="添加群组到文件夹" :visible.sync="value" :before-close="close" width="30%">
      <div style="margin:auto">
        <el-input placeholder="关键字搜索文件夹" style="width:60%;margin:0 20%" suffix-icon="el-icon-search" @input='searchNeedfile($event)'
          v-model="file_name">
        </el-input>
      </div>
      <div>
