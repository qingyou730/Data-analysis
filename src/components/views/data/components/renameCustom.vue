<template>
  <div class="custom-rewrite-file">
    <el-dialog title="重命名报表名称" :visible.sync="value" :before-close="close" :close-on-click-modal="wrapper_no" width="30%">
  ...
  export default {
    ...
    methods: {
      ...
      submit() {
        ...
        let url = this.$store.state.api_url.dynamicDroup.rename_dynamic_group;
        let data = {
          "id": this.id,
