<template>
  <div>
    ...
    >总共<span style=" color: rgb(62, 143, 255);">{{ total }}</span>条</div>
    <div
      style="width: 100%; padding-left: 75%; margin: 18px 0; color:#606266; box-sizing: border-box;"
    >只展示前50条的提示，了解更多详情请点击右上方下载按钮</div>
  </div>
</template>
<script>
export default {
